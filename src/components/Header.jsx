  ...
  return (
    ...
    <div className="container flex justify-between h-16 mx-auto">
      ...
      <div className="items-center flex-shrink-0 hidden lg:flex">
        <NavLink to="/register" className="self-center px-8 py-3 rounded">Register</NavLink>  
        <NavLink to="/login" className="self-center px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50">Login</NavLink>
      </div>
